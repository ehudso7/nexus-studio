...
export class DeploymentManager {
    ...
    constructor() {
        ...
        if (process.env.VERCEL_API_TOKEN) {
            this.providers.set('vercel', new VercelProvider(process.env.VERCEL_API_TOKEN, process.env.VERCEL_TEAM_ID));
        }
        if (process.env.NETLIFY_API_TOKEN) {
            this.providers.set('netlify', new NetlifyProvider(process.env.NETLIFY_API_TOKEN));
        }
        if (process.env.CLOUDFLARE_API_TOKEN && process.env.CLOUDFLARE_ACCOUNT_ID) {
            this.providers.set('cloudflare', new CloudflareProvider(process.env.CLOUDFLARE_API_TOKEN, process.env.CLOUDFLARE_ACCOUNT_ID));
        }
        if (process.env.FLY_API_TOKEN) {
            this.providers.set('fly', new FlyProvider(process.env.FLY_API_TOKEN));
        }
    }
    async deploy(projectId, provider, environment) {
    ...
    async monitorDeployment(deploymentId, providerName, providerDeploymentId) {
